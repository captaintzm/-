...
export function select () {
  ...
  return {
    // isOpen: false,
    url: '/ybt-supply/sys/menu/select',
    type: 'get',
    data: {
      'msg': 'success',
      'code': 0,
...
export function update () {
  return {
    // isOpen: false,
    url: '/ybt-supply/sys/menu/update',
    type: 'post',
    data: {
      'msg': 'success',
      'code': 0
...
export function del () {
  return {
    // isOpen: false,
    url: '/ybt-supply/sys/menu/delete',
    type: 'post',
    data: {
      'msg': 'success',
      'code': 0
